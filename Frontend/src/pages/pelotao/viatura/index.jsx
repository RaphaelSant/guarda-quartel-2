...
export default function PelotaoViatura() {
    ...
    useEffect(() => {
        ...
        fetch("http://localhost:8081/pelotao_viatura")
    ...
    const fetchData = async () => {
        try {
            ...
            const res = await fetch("http://localhost:8081/pelotao_viatura");
    ...
    const handleRegistrarSubmit = async (event) => {
        ...
        try {
            ...
            const response = await fetch('http://localhost:8081/pelotao_viatura', {
    ...
    const buscarDadosPorId = async (id) => {
        try {
            ...
            const response = await axios.get(`http://localhost:8081/pelotao_viatura/selectId/${id}`);
    ...
    const atualizarDadosPorId = async (id) => {
        try {
            ...
            const response = await axios.put(`http://localhost:8081/pelotao_viatura/${id}`, {
    ...
    const deleteRegistro = async (id) => {
        ...
        try {
            const response = await fetch(`http://localhost:8081/pelotao_viatura/${id}`, {
