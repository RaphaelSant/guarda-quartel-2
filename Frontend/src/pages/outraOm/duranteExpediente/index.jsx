...
export default function OutraOmDuranteExpediente() {
    ...
    useEffect(() => {
        ...
        // Faz uma requisição para buscar dados de uma API em http://localhost:8081/outra_om_durante_expediente
        fetch("http://localhost:8081/outra_om_durante_expediente")
    ...
    const fetchData = async () => {
        try {
            ...
            const res = await fetch("http://localhost:8081/outra_om_durante_expediente");
    ...
    const handleRegistrarSubmit = async (event) => {
        ...
        try {
            ...
            const response = await fetch('http://localhost:8081/outra_om_durante_expediente', {
    ...
    const buscarDadosPorId = async (id) => {
        try {
            ...
            const response = await axios.get(`http://localhost:8081/outra_om_durante_expediente/selectId/${id}`);
    ...
    const atualizarDadosPorId = async (id) => {
        try {
            ...
            const response = await axios.put(`http://localhost:8081/outra_om_durante_expediente/${id}`, {
    ...
    const deleteRegistro = async (id) => {
        ...
        try {
            const response = await fetch(`http://localhost:8081/outra_om_durante_expediente/${id}`, {
    ...
    return (
        <>
                ...
                <nav aria-label="breadcrumb">
                    <ol className="breadcrumb">
                        ...
                        <li className="breadcrumb-item active" aria-current="page">
                            Militares de outras OM durante o expediente
                        </li>
                    </ol>
                </nav>
            </div>
            <p className="text-center d-print-none">Entrada e saída de militares outras organizações militares durante o expediente</p>
            ...
            >
                <ImpressaoHeader titulo="Entrada e saída de militares outras organizações militares durante o expediente" />
