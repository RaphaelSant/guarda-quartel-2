...
export default function OutraOmForaExpediente() {
    ...
    const fetchData = async () => {
        try {
            ...
            const res = await fetch(`${dbConfig()}/outra_om_fora_expediente`);
    ...
    const handleRegistrarSubmit = async (event) => {
        ...
        try {
            ...
            const response = await fetch(`${dbConfig()}/outra_om_fora_expediente`, {
    ...
    const buscarDadosPorId = async (id) => {
        try {
            ...
            const response = await axios.get(`${dbConfig()}/outra_om_fora_expediente/selectId/${id}`);
    ...
    const atualizarDadosPorId = async (id) => {
        try {
            ...
            const response = await axios.put(`${dbConfig()}/outra_om_fora_expediente/${id}`, {
    ...
    const deleteRegistro = async (id) => {
        ...
        try {
            const response = await fetch(`${dbConfig()}/outra_om_fora_expediente/${id}`, {
