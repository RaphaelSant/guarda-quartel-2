...
export default function ServicoAnteriorOutraOmViatura() {
    ...
    const fetchData = async () => {
        try {
            const response = await axios.get(`${dbConfig()}/servico_anterior_outra_om_viatura/${selectedDate}`);
    ...
    return (
        <>
            ...
            <p className="text-center d-print-none">Entrada e saída de viaturas de outras organizações militares do dia {formatDate(selectedDate)}</p>
