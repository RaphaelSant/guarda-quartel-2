...
export default function ServicoAnteriorPelotaoForaExpediente() {
    ...
    const fetchData = async () => {
        ...
        try {
            const response = await axios.get(`${dbConfig()}/servico_anterior_pelotao_fora_expediente/${selectedDate}`);
    ...
    return (
        <>
            ...
            <p className="text-center d-print-none">Entrada e saída de militares do pelotão fora do horário de expediente do dia {formatDate(selectedDate)}</p>
